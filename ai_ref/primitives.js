...
import { createEffect, createSignal, onMount, sharedConfig } from "solid-js";
 ...
 * })
 */
export function createMousePosition(target, options = {}) {
  const fallback = {
    ...DEFAULT_MOUSE_POSITION,
 ...
 * })
 */
export function createPositionToElement(element, pos, options = {}) {
  const fallback = {
    ...DEFAULT_RELATIVE_ELEMENT_POSITION,
    ...options.initialValue,
  };
